...
class MO_Author_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        /* Widget settings. */
        $widget_ops = array('classname' => 'author-widget',
                            'description' => esc_html__('A widget that displays the post author information.', 'livemesh-theme-addons'));

        /* Widget control settings. */
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'mo-author-widget');

        /* Create the widget. */
        parent::__construct('mo-author-widget', esc_html__('Author Widget', 'livemesh-theme-addons'), $widget_ops, $control_ops);
    }
        ...
        <div id="author-widget" class="clearfix">
            ...
            <div class='author'>
                ...
                <ul class='social-list clearfix'>
                    <?php
                    if ($twitter_url)
                        echo "<li><a class=\"twitter\" href=\"$twitter_url\" title=\"Follow $author_name on Twitter\"><i class=\"icon-twitter\"></i></a></li>";
                    if ($facebook_url)
                        echo "<li><a class=\"facebook\" href=\"$facebook_url\" title=\"Follow $author_name on Facebook\"><i class=\"icon-facebook\"></i></a></li>";
                    if ($linkedin_url)
                        echo "<li><a class=\"linkedin\" href=\"$linkedin_url\" title=\"Follow $author_name on Linkedin\"><i class=\"icon-linkedin\"></i></a></li>";
                    if ($googleplus_url)
                        echo "<li><a class=\"googleplus\" href=\"$googleplus_url\" title=\"Follow $author_name on Google Plus\"><i class=\"icon-google-plus\"></i></a></li>";
                    if ($flickr_url)
                        echo "<li><a class=\"flickr\" href=\"$flickr_url\" title=\"Follow $author_name on Flickr\"><i class=\"icon-flickr\"></i></a></li>";
                    ?>
                </ul>
            </div>
        </div>
    ...
    function form($instance) {
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title:(optional)', 'livemesh-theme-addons'); ?></label>
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('avatar_size')); ?>"><?php esc_html_e('Avatar Size:', 'livemesh-theme-addons'); ?></label>
