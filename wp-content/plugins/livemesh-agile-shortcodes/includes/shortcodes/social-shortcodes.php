...
add_shortcode('subscribe_rss', 'lags_subscribe_rss');
...
function lags_social_list_shortcode($atts, $content = null, $code = "") {
    ...
    if ($email)
        $output .= '<li><a class="email" href="mailto:' . $email . '" title="' . __("Contact Us", "agile") . '"><i class="icon-envelope"></i></a></li>';
    if ($facebook_url)
        $output .= '<li><a class="facebook" href="' . $facebook_url . '" target="_blank" title="' . __("Follow on Facebook", "agile") . '"><i class="icon-facebook"></i></a></li>';
    if ($twitter_url)
        $output .= '<li><a class="twitter" href="' . $twitter_url . '" target="_blank" title="' . __("Subscribe to Twitter Feed", "agile") . '"><i class="icon-twitter"></i></a></li>';
    if ($flickr_url)
        $output .= '<li><a class="flickr" href="' . $flickr_url . '" target="_blank" title="' . __("View Flickr Portfolio", "agile") . '"><i class="icon-flickr"></i></a></li>';
    if ($youtube_url)
        $output .= '<li><a class="youtube" href="' . $youtube_url . '" target="_blank" title="' . __("Subscribe to the YouTube channel", "agile") . '"><i class="icon-youtube"></i></a></li>';
    if ($linkedin_url)
        $output .= '<li><a class="linkedin" href="' . $linkedin_url . '" target="_blank" title="' . __("View LinkedIn Profile", "agile") . '"><i class="icon-linkedin"></i></a></li>';
    if ($googleplus_url)
        $output .= '<li><a class="googleplus" href="' . $googleplus_url . '" target="_blank" title="' . __("Follow on Google Plus", "agile") . '"><i class="icon-google-plus"></i></a></li>';
    if ($vimeo_url)
        $output .= '<li><a class="vimeo" href="' . $vimeo_url . '" target="_blank" title="' . __("Subscribe to the Vimeo Channel", "agile") . '"><i class="icon-vimeo"></i></a></li>';
    if ($instagram_url)
        $output .= '<li><a class="instagram" href="' . $instagram_url . '" target="_blank" title="' . __("View Instagram Feed", "agile") . '"><i class="icon-instagram"></i></a></li>';
    if ($behance_url)
        $output .= '<li><a class="behance" href="' . $behance_url . '" target="_blank" title="' . __("View Behance Portfolio", "agile") . '"><i class="icon-behance"></i></a></li>';
    if ($pinterest_url)
        $output .= '<li><a class="pinterest" href="' . $pinterest_url . '" target="_blank" title="' . __("Subscribe to Pinterest Feed", "agile") . '"><i class="icon-pinterest"></i></a></li>';
    if ($skype_url)
        $output .= '<li><a class="skype" href="' . $skype_url . '" target="_blank" title="' . __("Connect to us on Skype", "agile") . '"><i class="icon-skype"></i></a></li>';
    if ($dribbble_url)
        $output .= '<li><a class="dribbble" href="' . $dribbble_url . '" target="_blank" title="' . __("View Dribbble Portfolio", "agile") . '"><i class="icon-dribbble"></i></a></li>';

    if ($include_rss && lags_to_boolean($include_rss)) {
        $rss = get_bloginfo('rss2_url');
        $output .= '<li><a class="rss" href="' . $rss . '" target="_blank" title="' . __("Subscribe to our RSS Feed", "agile") . '"><i class="icon-feed"></i></a></li>';
    }
...
add_shortcode('social_list', 'lags_social_list_shortcode');
...
function lags_paypal_donate_shortcode($atts) {
    extract(shortcode_atts(array(
    ...
    $display_card_logos = lags_to_boolean($display_card_logos);
...
add_shortcode('donate', 'lags_paypal_donate_shortcode');
