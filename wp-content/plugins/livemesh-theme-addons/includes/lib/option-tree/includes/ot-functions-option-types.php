...
if ( ! function_exists( 'ot_type_background' ) ) {
	...
	function ot_type_background( $args = array() ) {
		...
		// Description.
		echo $has_desc ? '<div class="description">' . wp_kses_post( wp_specialchars_decode( $field_desc ) ) . '</div>' : '';
...
if ( ! function_exists( 'ot_type_upload' ) ) {
	...
	function ot_type_upload( $args = array() ) {
		...
		// Description.
		echo $has_desc ? '<div class="description">' . wp_kses_post( wp_specialchars_decode( $field_desc ) ) . '</div>' : ''; // phpcs:ignore
