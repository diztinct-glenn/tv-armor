...
require_once(get_template_directory() . '/inc/vc-extensions/vc-extender.php');
...
function mo_add_widget_tabs($tabs) {
    $tabs[] = array(
        'title' => __('Livemesh Theme Widgets', 'agile'),
        'filter' => array(
...
function mo_row_style_fields($fields) {
    ...
    $fields['row_id'] = array(
        'name' => __('Row ID for styling', 'agile'),
        'type' => 'text',
        'group' => 'attributes',
        'description' => __('An ID for the row for styling purposes.', 'agile'),
        'priority' => 4,
    );
