...
class MO_Recent_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        /* Widget settings. */
        $widget_ops = array('classname' => 'recent-posts-widget',
                            'description' => esc_html__('A widget that displays the recent posts with thumbnails.', 'livemesh-theme-addons'));

        /* Widget control settings. */
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'mo-recent-posts-widget');

        /* Create the widget. */
        parent::__construct('mo-recent-posts-widget', esc_html__('Recent Posts Widget', 'livemesh-theme-addons'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        $query_args = array('posts_per_page' => $post_count, 'ignore_sticky_posts' => 1, 'orderby' => 'date', 'order' => 'DESC');
    ...
    function get_widget_defaults() {
        /* Set up some default widget settings. */
        $defaults = array('title' => esc_html__('Recent Posts', 'livemesh-theme-addons'),
                          'post_count' => '5',
                          'excerpt_count' => '100',
