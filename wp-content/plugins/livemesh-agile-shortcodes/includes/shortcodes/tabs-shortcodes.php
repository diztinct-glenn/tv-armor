...
function lags_tabgroup_shortcode($atts, $content)
{
...
add_shortcode('tabgroup', 'lags_tabgroup_shortcode');
...
*/
function lags_tab_shortcode($atts, $content)
{
    global $tab_count, $tabs;
...
add_shortcode('tab', 'lags_tab_shortcode');

/*
* jQuery Tools - Accordion shortcode 
*/

function lags_accordion_shortcode($atts, $content = null)
{
...
add_shortcode('accordion', 'lags_accordion_shortcode');

function lags_pane_shortcode($atts, $content = null)
{
...
add_shortcode('pane', 'lags_pane_shortcode');
/* Toggle Shortcode -
...
*/
function lags_toggle_shortcode($atts, $content = null, $code = "")
{
    extract(shortcode_atts(array(
        'title' => '',
        'type' => ''
...
add_shortcode('toggle', 'lags_toggle_shortcode');