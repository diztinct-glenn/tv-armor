...
$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'vc_row-custom vc_row wpb_row vc_row-fluid ' . ($mo_padding == "none" ? 'no-padding ' : '') . ($vc_inner ? 'vc_inner ' : '') . ((empty($mo_row_type) || $mo_row_type == 'in_container') ? 'vc_row-in-container ' : 'vc_row-full-width ') . $mo_class . $text_scheme . $parallax_classes, $this->settings['base'], $atts);
