...
class MO_Video_Section_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        parent::__construct(
            "mo-video-section", __("HTML5 Video Section", "agile"), array(
            "description" => __("Displays a section with HTML5 video background. Controls for play/pause/mute are provided to the bottom right.", "agile"),
