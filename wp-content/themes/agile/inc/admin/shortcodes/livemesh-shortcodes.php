...
class LivemeshShortcodes {
    ...
    function __construct() {
        define('LIVEMESH_TINYMCE_URI', get_template_directory_uri() . '/inc/admin/shortcodes/tinymce');
        define('LIVEMESH_TINYMCE_DIR', get_template_directory() . '/inc/admin/shortcodes/tinymce');
    ...
    public function admin_menu_styles($hook) {
        if ($hook == 'post.php' || $hook == 'post-new.php') {
            ...
            wp_localize_script('jquery', 'LivemeshShortcodes', array(
                ...
                'media_frame_video_title' => __('Upload or Choose Your Custom Video File', 'agile'),
                'media_frame_image_title' => __('Upload or Choose Your Custom Image File', 'agile')
            ));
        }
    }
        ...
        <div id="livemesh-popup">
            ...
            <div id="livemesh-sc-wrap">
                ...
                <div id="livemesh-sc-form-wrap">
                    <h2 id="livemesh-sc-form-head"><?php echo esc_html($shortcode->popup_title); ?></h2>
                ...
                <form method="post" id="livemesh-sc-form">
                    ...
                    <table id="livemesh-sc-form-table">
                        ...
                        <?php echo wp_specialchars_decode($shortcode->output); ?>
                    ...
                    <div class="insert-field">
                        <a href="#"
                           class="button button-primary button-large livemesh-insert"><?php _e('Insert Shortcode', 'agile'); ?></a>
                    </div>
