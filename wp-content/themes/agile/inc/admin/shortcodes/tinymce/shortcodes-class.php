...
class livemesh_shortcodes {
    ...
    function __construct($popup) {
        if (file_exists(dirname(__FILE__) . '/config.php')) {
            ...
            $this->append_error(__('Config file does not exist', 'agile'));
        }
    }
        ...
        if (isset($livemesh_shortcodes) && is_array($livemesh_shortcodes)) {
            ...
            foreach ($this->params as $pkey => $param) {
                ...
                switch ($param['type']) {
                    ...
                    case 'image';
                        $output = $row_start;
                        $output .= '<a href="#" data-id="' . $pkey . '" data-type="image" data-text="Insert Image" class="livemesh-open-media button" title="' . esc_attr__('Choose Image', 'agile') . '">' . __('Choose Image', 'agile') . '</a>';
                    ...
                    case 'video';
                        $output = $row_start;
                        $output .= '<a href="#" data-id="' . $pkey . '" data-type="video" data-text="Insert Video" class="livemesh-open-media button" title="' . esc_attr__('Choose Video', 'agile') . '">' . __('Choose Video', 'agile') . '</a>';
                        $output .= '<input class="livemesh-input" type="text" name="' . $pkey . '" id="' . $pkey . '" value="' . $param['std'] . '" />';
                        $output .= $row_end;
                        $this->append_output($output);
                        break;
