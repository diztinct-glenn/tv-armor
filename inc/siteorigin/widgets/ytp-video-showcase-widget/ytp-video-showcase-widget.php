...
class MO_YTP_Video_Showcase_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        parent::__construct(
            "mo-ytp-video-showcase", __("YouTube Video Showcase", "agile"), array(
            "description" => __("Displays an YouTube video with controls for play/pause/mute. The video is not auto-played by default and waits for the user input via the play button.", "agile"),
